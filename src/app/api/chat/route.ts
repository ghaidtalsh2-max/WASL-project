  ...
  try {
    ...
    if (aiRes.error) {
      return NextResponse.json({
        success: false,
        error: aiRes.error,
        reply: 'I am currently having difficulty reaching the live intelligence service. Please check your API settings.',
        replyAr: 'أواجه حالياً صعوبة مؤقتة في الاتصال بخدمة الذكاء الاصطناعي. يرجى التحقق من إعدادات المفتاح في الإعدادات.',
      });
    }
